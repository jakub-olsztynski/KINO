  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Seanse Dzisiaj</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box">
         <div class="box-header with-border">
              <h3 class="box-title">Dostępne seanse</h3>
            </div>
        <div class="box-body">
          <?php
            ...
            <table class="table">
              ...
              while($shows=mysqli_fetch_array($sw))
              {
                ...
                <tr>
                  ...
                  <td>
                    <?php echo date('h:i A',strtotime($show_time['start_time']))." ( ".$show_time['name'].")";?>
                  </td>
                  <td>
          ...
          {
            ?>
            <h3>Nie dodano żadnych seansów</h3>
            <?php
          }
          ?>
        </div> 
