						...
						<h3 style="color:#444; font-size:23px;" class="text-center"><?php echo $movie['movie_name']; ?></h3>	
							<div class="about-top">	
								...
								<div class="desc span_3_of_2">
									...
									<a href="<?php echo $movie['video_url']; ?>" target="_blank" class="watch_but" style="text-decoration:none;">Zobacz zwiastun</a>
								</div>
								<div class="clear"></div>
							</div>
							...
							<table class="table table-hover table-bordered text-center">
								<h3 style="color:#444;" class="text-center">Nadchodzące seanse</h3>
							...
							{
								?>
								<h3 style="color:#444; font-size:23px;" class="text-center">Brak nadchodzących seansów</h3>
								<?php
							}
							?>
