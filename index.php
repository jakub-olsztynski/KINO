	...
	<div class="wrap">
		<div class="content-top">
				<div class="listview_1_of_3 images_1_of_3">
					<h2 style="color:#555;">Nadchodzące premiery</h2>
					<?php 
				...
				<div class="content-left">
					...
					<div class="text list_1_of_2">
						  <div class="extra-wrap">
						  	...
						  	<span style="text-color:#000" class="data"><strong>Obsada: <?php echo $n['cast'];?></strong><br>
                                <div class="data">Data premiery: <?php echo $n['news_date'];?></div>
		...
		<div class="listview_1_of_3 images_1_of_3">
					<h2 style="color:#555;">Zwiastuny</h2>
