 			...
 			<div class="listview_1_of_3 images_1_of_3">
					<h2 style="color:#555;">Repertuar</h2>
            ...
            <div class="content-left">
					...
					<div class="text list_1_of_2">
						  <div class="extra-wrap1">
                                        ...
                                        <span class="data">Data premiery: <?php echo $m['release_date'];?></span><br>
                                        Obsada: <Span class="data"><?php echo $m['cast'];?></span><br>
                                        Opis: <span" class="color2" style="text-decoration:none;"><?php echo $m['desc'];?></span><br>
                                    </div>
					</div>
